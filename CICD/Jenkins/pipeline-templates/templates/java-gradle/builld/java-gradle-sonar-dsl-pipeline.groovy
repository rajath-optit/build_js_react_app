        ...
        stage('Code Analysis') {
            steps {
                script {
                        ...
                        def sonarQubeScript = load 'CICD/Jenkins/shared-libraries/vars/common/code-analysis/sonarqube-util/sonarQubeAnalysis.groovy'
                        sonarQubeScript.sonarQubeAnalysis()
                    }
                }
            }
        }
